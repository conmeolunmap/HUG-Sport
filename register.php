...
if($_POST['txtTenDangNhap']=="" || $_POST['txtMatKhau1'] =="" || $_POST['txtHoTen']=="" || $_POST['txtEmail']=="" || $_POST['txtDiaChi']=="" || $_POST['txtDienThoai']=="" || !isset($gioitinh)){
	...
	if($loi!=""){
		...
		$sql =" SELECT * FROM taikhoan WHERE username_tk='$TenDangNhap' OR email_tk='$email'";
		$ketqua = mysqli_query($conn,$sql);
		if(mysqli_num_rows($ketqua)==0)
		{
		mysqli_query($conn,"INSERT INTO taikhoan(username_tk, pass_tk, ten_tk, gioitinh_tk, diachi_tk, sodienthoai_tk, email_tk, ngaysinh_tk, kh_thangsinh, kh_namsinh, cmnd_tk, makichhoat_tk, trangthai_tk, loaitk) 
		VALUE ('$TenDangNhap','".md5($MatKhau)."','$hoten',$gioitinh, '$diachi','$sodienthoai','$email','$ngaysinh','$thangsinh','$namsinh','','',0,0)") or die(mysqli_error($conn));
